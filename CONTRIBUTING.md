...
First off, thank you for considering contributing to the library iso20022-ch!
### 1. Where do I go from here?

If you've noticed a bug or have a question that doesn't belong on the
[wiki](https://github.com/dvbern/iso20022/wiki), then
[search the issue tracker](https://github.com/dvbern/iso20022/issues)
to see if someone else in the community has already created a ticket regarding your issue.
If not, feel free to go ahead and [make one](https://github.com/dvbern/iso20022/issues/new)!

### 2. Did you find a bug?

* **Ensure the bug was not already reported** by searching on GitHub under 
[Issues](https://github.com/dvbern/iso20022/issues).

* If you're unable to find an open issue addressing the problem, 
[open a new one](https://github.com/dvbern/iso20022/issues/new). 
...
[fork iso20022](https://help.github.com/articles/fork-a-repo)
...
```sh
git remote add upstream git@github.com/dvbern/iso20022.git
git checkout master
