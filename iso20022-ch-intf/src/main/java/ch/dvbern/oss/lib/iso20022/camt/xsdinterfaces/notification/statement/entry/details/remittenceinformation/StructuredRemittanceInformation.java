...
public interface StructuredRemittanceInformation {
	...
	/**
	 * <pre>
	 * QR: In separate element:
	 * QR-IBAN or IBAN with SCOR:
	 * Additional information from the QR Code
	 *
	 * In case of IBAN without SCOR:
	 * The messages are shown in the unstructured part
	 * “Ustrd”.
	 * QR_Feld: QRCH
	 * +RmtInf
	 * ++AddInf
	...
	@Nullable
	CreditorReferenceInformation getCdtrRefInf();
}
