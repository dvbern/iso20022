...
/**
 * Tests the CamtServiceBean with the file camt_054_Beispiel_SammelbuchungEs.xml which contains 'Sammelbuchungen
 * ES'
 * Sammelbuchungen are ignored as their transaction details have no reference number
 */
public class Camt054V00104ServiceSammelEsTest {

	private static final String PATH =
		"ch/dvbern/oss/lib/iso20022/camt054/v00104/camt_054_Beispiel_SammelbuchungEs.xml";

	private final CamtService service = new CamtServiceBean();

	private final LocalDateTime creDtTm = LocalDateTime.of(2017, 7, 27, 14, 0, 40);
	...
	public void testMessageIdentification() {
		...
		assertEquals("MSGID-201707271400", messageIdentifier.getMessageIdentification());
	...
	public void testAccounts() {
		...
		assertEquals("NtfctnId20170727", account.getIdentification());
	...
	public void testBooking() {
		...
		assertEquals(LocalDate.of(2017, 7, 27).atStartOfDay(), booking.getBookingDate());
		assertEquals(LocalDate.of(2017, 7, 27).atStartOfDay(), booking.getValueDate());
	}
