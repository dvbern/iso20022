...
@XmlType(name = "CardTransaction1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "aggtd",
    "indv"
})
public class CardTransaction1Choice {

    @XmlElement(name = "Aggtd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected CardAggregated1 aggtd;
    @XmlElement(name = "Indv", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
