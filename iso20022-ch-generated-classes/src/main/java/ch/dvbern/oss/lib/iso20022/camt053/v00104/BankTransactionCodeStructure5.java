...
@XmlType(name = "BankTransactionCodeStructure5", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "cd",
    "fmly"
})
public class BankTransactionCodeStructure5 {
    ...
    protected String cd;
    @XmlElement(name = "Fmly", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
