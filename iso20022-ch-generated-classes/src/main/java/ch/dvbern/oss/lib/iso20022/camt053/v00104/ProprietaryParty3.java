...
@XmlType(name = "ProprietaryParty3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "tp",
    "pty"
})
public class ProprietaryParty3 {
    ...
    protected String tp;
    @XmlElement(name = "Pty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
