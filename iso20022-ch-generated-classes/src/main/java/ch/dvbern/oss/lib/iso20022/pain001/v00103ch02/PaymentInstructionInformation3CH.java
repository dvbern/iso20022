...
@XmlType(name = "PaymentInstructionInformation3-CH", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", propOrder = {
    "pmtInfId",
    "pmtMtd",
    "btchBookg",
    "nbOfTxs",
...
public class PaymentInstructionInformation3CH {
    ...
    @XmlElement(name = "PmtInfId", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    protected String pmtInfId;
    @XmlElement(name = "PmtMtd", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    @XmlSchemaType(name = "string")
    protected PaymentMethod3Code pmtMtd;
    @XmlElement(name = "BtchBookg", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd")
    protected Boolean btchBookg;
    @XmlElement(name = "NbOfTxs", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd")
    ...
    @XmlElement(name = "ReqdExctnDt", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar reqdExctnDt;
    @XmlElement(name = "Dbtr", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    protected PartyIdentification32CH dbtr;
    @XmlElement(name = "DbtrAcct", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    protected CashAccount16CHIdTpCcy dbtrAcct;
    @XmlElement(name = "DbtrAgt", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
    ...
    @XmlElement(name = "ChrgsAcct", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd")
    protected CashAccount16CHIdAndCurrency chrgsAcct;
    @XmlElement(name = "CdtTrfTxInf", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", required = true)
