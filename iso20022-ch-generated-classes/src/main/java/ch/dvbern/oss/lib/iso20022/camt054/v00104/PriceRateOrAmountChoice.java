...
@XmlType(name = "PriceRateOrAmountChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "rate",
    "amt"
})
public class PriceRateOrAmountChoice {
    ...
    @XmlElement(name = "Amt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
