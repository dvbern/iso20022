...
@XmlType(name = "TaxParty2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "taxId",
    "regnId",
    "taxTp",
    "authstn"
...
public class TaxParty2 {
    ...
    @XmlElement(name = "TaxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String taxId;
    @XmlElement(name = "RegnId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String regnId;
    @XmlElement(name = "TaxTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String taxTp;
    @XmlElement(name = "Authstn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
