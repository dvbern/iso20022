...
@XmlType(name = "PointOfInteractionComponent1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "poiCmpntTp",
    "manfctrId",
    "mdl",
    "vrsnNb",
...
public class PointOfInteractionComponent1 {
    ...
    @XmlElement(name = "POICmpntTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    @XmlSchemaType(name = "string")
    protected POIComponentType1Code poiCmpntTp;
    @XmlElement(name = "ManfctrId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String manfctrId;
    @XmlElement(name = "Mdl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String mdl;
    @XmlElement(name = "VrsnNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String vrsnNb;
    @XmlElement(name = "SrlNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String srlNb;
    @XmlElement(name = "ApprvlNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
