...
@XmlType(name = "BankTransactionCodeStructure6", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "cd",
    "subFmlyCd"
})
public class BankTransactionCodeStructure6 {

    @XmlElement(name = "Cd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String cd;
    @XmlElement(name = "SubFmlyCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
