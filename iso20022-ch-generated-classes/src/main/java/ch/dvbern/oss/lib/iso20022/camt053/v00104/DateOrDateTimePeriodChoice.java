...
@XmlType(name = "DateOrDateTimePeriodChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "dt",
    "dtTm"
})
public class DateOrDateTimePeriodChoice {
    ...
    @XmlElement(name = "DtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
