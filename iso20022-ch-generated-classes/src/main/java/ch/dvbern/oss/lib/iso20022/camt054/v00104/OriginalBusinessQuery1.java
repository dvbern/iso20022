...
@XmlType(name = "OriginalBusinessQuery1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "msgId",
    "msgNmId",
    "creDtTm"
})
public class OriginalBusinessQuery1 {
    ...
    @XmlElement(name = "MsgNmId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String msgNmId;
    @XmlElement(name = "CreDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
