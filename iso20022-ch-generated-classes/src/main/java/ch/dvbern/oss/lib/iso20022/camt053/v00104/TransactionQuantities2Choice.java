...
@XmlType(name = "TransactionQuantities2Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "qty",
    "orgnlAndCurFaceAmt",
    "prtry"
})
public class TransactionQuantities2Choice {
    ...
    @XmlElement(name = "Qty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected FinancialInstrumentQuantityChoice qty;
    @XmlElement(name = "OrgnlAndCurFaceAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
