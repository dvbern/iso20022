...
@XmlType(name = "PaymentReturnReason2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "orgnlBkTxCd",
    "orgtr",
    "rsn",
    "addtlInf"
...
public class PaymentReturnReason2 {
    ...
    @XmlElement(name = "OrgnlBkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected BankTransactionCodeStructure4 orgnlBkTxCd;
    @XmlElement(name = "Orgtr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected PartyIdentification43 orgtr;
    @XmlElement(name = "Rsn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
