...
@XmlType(name = "Party11Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "orgId",
    "prvtId"
})
public class Party11Choice {

    @XmlElement(name = "OrgId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected OrganisationIdentification8 orgId;
    @XmlElement(name = "PrvtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
