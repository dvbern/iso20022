...
@XmlType(name = "TransactionInterest3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "ttlIntrstAndTaxAmt",
    "rcrd"
})
public class TransactionInterest3 {

    @XmlElement(name = "TtlIntrstAndTaxAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
