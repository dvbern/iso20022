...
@XmlType(name = "CardTransaction1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "card",
    "poi",
    "tx"
})
public class CardTransaction1 {
    ...
    @XmlElement(name = "Tx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
