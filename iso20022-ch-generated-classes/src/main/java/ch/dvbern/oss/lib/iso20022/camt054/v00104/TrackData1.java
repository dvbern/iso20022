...
@XmlType(name = "TrackData1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "trckNb",
    "trckVal"
})
public class TrackData1 {

    @XmlElement(name = "TrckNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String trckNb;
    @XmlElement(name = "TrckVal", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
