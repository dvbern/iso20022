...
@XmlType(name = "GroupHeader58", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "msgId",
    "creDtTm",
    "msgRcpt",
    "msgPgntn",
...
public class GroupHeader58 {
    ...
    @XmlElement(name = "MsgId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String msgId;
    @XmlElement(name = "CreDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar creDtTm;
    @XmlElement(name = "MsgRcpt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PartyIdentification43 msgRcpt;
    @XmlElement(name = "MsgPgntn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Pagination msgPgntn;
    @XmlElement(name = "OrgnlBizQry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
