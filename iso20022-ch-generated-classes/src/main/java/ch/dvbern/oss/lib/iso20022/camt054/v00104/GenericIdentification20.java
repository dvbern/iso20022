...
@XmlType(name = "GenericIdentification20", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "id",
    "issr",
    "schmeNm"
})
public class GenericIdentification20 {
    ...
    protected String id;
    @XmlElement(name = "Issr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    protected String issr;
    @XmlElement(name = "SchmeNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
