...
@XmlType(name = "CorporateAction9", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "evtTp",
    "evtId"
})
public class CorporateAction9 {

    @XmlElement(name = "EvtTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String evtTp;
    @XmlElement(name = "EvtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
