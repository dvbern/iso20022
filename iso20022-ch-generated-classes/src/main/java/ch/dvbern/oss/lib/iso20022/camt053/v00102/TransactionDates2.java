...
public class TransactionDates2 {
    ...
    @XmlElement(name = "AccptncDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    ...
    @XmlElement(name = "TxDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02")
    @XmlSchemaType(name = "dateTime")
