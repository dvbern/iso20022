...
@XmlType(name = "AccountStatement4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "id",
    "stmtPgntn",
    "elctrncSeqNb",
    "lglSeqNb",
...
public class AccountStatement4 {
    ...
    protected String id;
    @XmlElement(name = "StmtPgntn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Pagination stmtPgntn;
    @XmlElement(name = "ElctrncSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal elctrncSeqNb;
    @XmlElement(name = "LglSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal lglSeqNb;
    @XmlElement(name = "CreDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar creDtTm;
    @XmlElement(name = "FrToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected DateTimePeriodDetails frToDt;
    @XmlElement(name = "CpyDplctInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    @XmlSchemaType(name = "string")
    protected CopyDuplicate1Code cpyDplctInd;
    @XmlElement(name = "RptgSrc", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected ReportingSource1Choice rptgSrc;
    @XmlElement(name = "Acct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected CashAccount25 acct;
    @XmlElement(name = "RltdAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "Bal", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected List<CashBalance3> bal;
    @XmlElement(name = "TxsSummry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TotalTransactions4 txsSummry;
    @XmlElement(name = "Ntry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<ReportEntry4> ntry;
    @XmlElement(name = "AddtlStmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
