...
@XmlType(name = "OtherIdentification1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "id",
    "sfx",
    "tp"
})
public class OtherIdentification1 {
    ...
    protected String id;
    @XmlElement(name = "Sfx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
