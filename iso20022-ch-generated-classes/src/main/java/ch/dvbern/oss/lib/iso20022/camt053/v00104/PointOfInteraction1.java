...
@XmlType(name = "PointOfInteraction1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "id",
    "sysNm",
    "grpId",
    "cpblties",
...
public class PointOfInteraction1 {
    ...
    @XmlElement(name = "SysNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String sysNm;
    @XmlElement(name = "GrpId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String grpId;
    @XmlElement(name = "Cpblties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PointOfInteractionCapabilities1 cpblties;
    @XmlElement(name = "Cmpnt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
