...
@XmlType(name = "TransactionPrice3Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "dealPric",
    "prtry"
})
public class TransactionPrice3Choice {

    @XmlElement(name = "DealPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
