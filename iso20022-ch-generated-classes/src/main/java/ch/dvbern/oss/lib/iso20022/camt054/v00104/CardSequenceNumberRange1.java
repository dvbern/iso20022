...
@XmlType(name = "CardSequenceNumberRange1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "frstTx",
    "lastTx"
})
public class CardSequenceNumberRange1 {

    @XmlElement(name = "FrstTx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String frstTx;
    @XmlElement(name = "LastTx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
