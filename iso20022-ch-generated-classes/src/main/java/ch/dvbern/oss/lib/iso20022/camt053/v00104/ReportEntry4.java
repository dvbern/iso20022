...
@XmlType(name = "ReportEntry4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "ntryRef",
    "amt",
    "cdtDbtInd",
    "rvslInd",
...
public class ReportEntry4 {
    ...
    @XmlElement(name = "NtryRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "RvslInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Boolean rvslInd;
    @XmlElement(name = "Sts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    @XmlSchemaType(name = "string")
    protected EntryStatus2Code sts;
    @XmlElement(name = "BookgDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected DateAndDateTimeChoice bookgDt;
    @XmlElement(name = "ValDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected DateAndDateTimeChoice valDt;
    @XmlElement(name = "AcctSvcrRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "BkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected BankTransactionCodeStructure4 bkTxCd;
    @XmlElement(name = "ComssnWvrInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Boolean comssnWvrInd;
    @XmlElement(name = "AddtlInfInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "TechInptChanl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "NtryDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<EntryDetails3> ntryDtls;
    @XmlElement(name = "AddtlNtryInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
