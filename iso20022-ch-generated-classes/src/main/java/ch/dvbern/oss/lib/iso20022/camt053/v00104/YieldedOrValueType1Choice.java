...
@XmlType(name = "YieldedOrValueType1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "yldd",
    "valTp"
})
public class YieldedOrValueType1Choice {

    @XmlElement(name = "Yldd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Boolean yldd;
    @XmlElement(name = "ValTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
