...
@XmlType(name = "PlainCardData1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "pan",
    "cardSeqNb",
    "fctvDt",
    "xpryDt",
...
public class PlainCardData1 {
    ...
    @XmlElement(name = "PAN", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    protected String pan;
    @XmlElement(name = "CardSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String cardSeqNb;
    @XmlElement(name = "FctvDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    @XmlSchemaType(name = "gYearMonth")
    protected XMLGregorianCalendar fctvDt;
    @XmlElement(name = "XpryDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    @XmlSchemaType(name = "gYearMonth")
    protected XMLGregorianCalendar xpryDt;
    @XmlElement(name = "SvcCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String svcCd;
    @XmlElement(name = "TrckData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected List<TrackData1> trckData;
    @XmlElement(name = "CardSctyCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
