...
@XmlType(name = "CashDeposit1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "noteDnmtn",
    "nbOfNotes",
    "amt"
})
public class CashDeposit1 {
    ...
    @XmlElement(name = "NoteDnmtn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected ActiveCurrencyAndAmount noteDnmtn;
    @XmlElement(name = "NbOfNotes", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
