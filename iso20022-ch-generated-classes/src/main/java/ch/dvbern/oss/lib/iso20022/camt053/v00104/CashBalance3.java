...
@XmlType(name = "CashBalance3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "tp",
    "cdtLine",
    "amt",
    "cdtDbtInd",
...
public class CashBalance3 {
    ...
    @XmlElement(name = "Tp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected BalanceType12 tp;
    @XmlElement(name = "CdtLine", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "Dt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
