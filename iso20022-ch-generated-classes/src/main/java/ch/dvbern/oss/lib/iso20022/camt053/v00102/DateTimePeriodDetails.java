...
public class DateTimePeriodDetails {
    ...
    @XmlElement(name = "FrDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar frDtTm;
    @XmlElement(name = "ToDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.02", required = true)
    @XmlSchemaType(name = "dateTime")
