...
@XmlType(name = "Rate3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "tp",
    "vldtyRg"
})
public class Rate3 {
    ...
    @XmlElement(name = "VldtyRg", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
