...
@XmlType(name = "CardEntry1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "card",
    "poi",
    "aggtdNtry"
})
public class CardEntry1 {
    ...
    @XmlElement(name = "Card", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PaymentCard4 card;
    @XmlElement(name = "POI", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PointOfInteraction1 poi;
    @XmlElement(name = "AggtdNtry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
