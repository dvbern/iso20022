...
@XmlType(name = "InterestRecord1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "amt",
    "cdtDbtInd",
    "tp",
    "rate",
...
public class InterestRecord1 {
    ...
    @XmlElement(name = "Rate", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "Rsn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
