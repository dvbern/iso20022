...
@XmlType(name = "Pagination", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "pgNb",
    "lastPgInd"
})
public class Pagination {

    @XmlElement(name = "PgNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String pgNb;
    @XmlElement(name = "LastPgInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
