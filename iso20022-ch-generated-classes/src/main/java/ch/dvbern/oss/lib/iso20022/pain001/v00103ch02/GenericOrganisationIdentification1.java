...
@XmlType(name = "GenericOrganisationIdentification1", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
public class GenericOrganisationIdentification1 {
    ...
    protected String id;
    @XmlElement(name = "SchmeNm", namespace = "http://www.six-interbank-clearing.com/de/pain.001.001.03.ch.02.xsd")
