...
@XmlType(name = "CardSecurityInformation1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "cscMgmt",
    "cscVal"
})
public class CardSecurityInformation1 {

    @XmlElement(name = "CSCMgmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    @XmlSchemaType(name = "string")
    protected CSCManagement1Code cscMgmt;
    @XmlElement(name = "CSCVal", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
