...
@XmlType(name = "Charges4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "ttlChrgsAndTaxAmt",
    "rcrd"
})
public class Charges4 {

    @XmlElement(name = "TtlChrgsAndTaxAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
