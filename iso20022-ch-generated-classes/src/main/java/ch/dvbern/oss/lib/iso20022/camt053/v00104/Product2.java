...
@XmlType(name = "Product2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "pdctCd",
    "unitOfMeasr",
    "pdctQty",
    "unitPric",
...
public class Product2 {
    ...
    @XmlElement(name = "PdctCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String pdctCd;
    @XmlElement(name = "UnitOfMeasr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    @XmlSchemaType(name = "string")
    protected UnitOfMeasure1Code unitOfMeasr;
    @XmlElement(name = "PdctQty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal pdctQty;
    @XmlElement(name = "UnitPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal unitPric;
    @XmlElement(name = "PdctAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal pdctAmt;
    @XmlElement(name = "TaxTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String taxTp;
    @XmlElement(name = "AddtlPdctInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
