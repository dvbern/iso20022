...
@XmlType(name = "ReferredDocumentInformation3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "tp",
    "nb",
    "rltdDt"
})
public class ReferredDocumentInformation3 {
    ...
    @XmlElement(name = "Nb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String nb;
    @XmlElement(name = "RltdDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
