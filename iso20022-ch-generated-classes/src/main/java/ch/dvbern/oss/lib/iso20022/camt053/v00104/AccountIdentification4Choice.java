...
@XmlType(name = "AccountIdentification4Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "iban",
    "othr"
})
public class AccountIdentification4Choice {

    @XmlElement(name = "IBAN", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
