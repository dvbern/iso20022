...
@XmlType(name = "ProprietaryQuantity1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "tp",
    "qty"
})
public class ProprietaryQuantity1 {
    ...
    protected String tp;
    @XmlElement(name = "Qty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
