...
@XmlType(name = "EntryTransaction4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "refs",
    "amt",
    "cdtDbtInd",
    "amtDtls",
...
public class EntryTransaction4 {
    ...
    @XmlElement(name = "Refs", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "CdtDbtInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    @XmlSchemaType(name = "string")
    protected CreditDebitCode cdtDbtInd;
    @XmlElement(name = "AmtDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected AmountAndCurrencyExchange3 amtDtls;
    @XmlElement(name = "Avlbty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<CashBalanceAvailability2> avlbty;
    @XmlElement(name = "BkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BankTransactionCodeStructure4 bkTxCd;
    @XmlElement(name = "Chrgs", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Charges4 chrgs;
    @XmlElement(name = "Intrst", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TransactionInterest3 intrst;
    @XmlElement(name = "RltdPties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TransactionParties3 rltdPties;
    @XmlElement(name = "RltdAgts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TransactionAgents3 rltdAgts;
    @XmlElement(name = "Purp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Purpose2Choice purp;
    @XmlElement(name = "RltdRmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<RemittanceLocation2> rltdRmtInf;
    @XmlElement(name = "RmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected RemittanceInformation7 rmtInf;
    @XmlElement(name = "RltdDts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TransactionDates2 rltdDts;
    @XmlElement(name = "RltdPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TransactionPrice3Choice rltdPric;
    @XmlElement(name = "RltdQties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<TransactionQuantities2Choice> rltdQties;
    @XmlElement(name = "FinInstrmId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected SecurityIdentification14 finInstrmId;
    @XmlElement(name = "Tax", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected TaxInformation3 tax;
    @XmlElement(name = "RtrInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PaymentReturnReason2 rtrInf;
    @XmlElement(name = "CorpActn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected CorporateAction9 corpActn;
    @XmlElement(name = "SfkpgAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected SecuritiesAccount13 sfkpgAcct;
    @XmlElement(name = "CshDpst", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected List<CashDeposit1> cshDpst;
    @XmlElement(name = "CardTx", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected CardTransaction1 cardTx;
    @XmlElement(name = "AddtlTxInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String addtlTxInf;
    @XmlElement(name = "SplmtryData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
