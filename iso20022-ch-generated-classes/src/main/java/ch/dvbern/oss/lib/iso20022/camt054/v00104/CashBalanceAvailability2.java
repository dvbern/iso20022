...
@XmlType(name = "CashBalanceAvailability2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "dt",
    "amt",
    "cdtDbtInd"
})
public class CashBalanceAvailability2 {
    ...
    @XmlElement(name = "Dt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
