...
@XmlType(name = "DisplayCapabilities1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "dispTp",
    "nbOfLines",
    "lineWidth"
})
public class DisplayCapabilities1 {
    ...
    @XmlElement(name = "DispTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    @XmlSchemaType(name = "string")
    protected UserInterface2Code dispTp;
    @XmlElement(name = "NbOfLines", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
    protected String nbOfLines;
    @XmlElement(name = "LineWidth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", required = true)
