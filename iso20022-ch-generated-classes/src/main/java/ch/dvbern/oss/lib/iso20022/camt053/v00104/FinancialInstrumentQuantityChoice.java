...
@XmlType(name = "FinancialInstrumentQuantityChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "unit",
    "faceAmt",
    "amtsdVal"
})
public class FinancialInstrumentQuantityChoice {
    ...
    @XmlElement(name = "Unit", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal unit;
    @XmlElement(name = "FaceAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BigDecimal faceAmt;
    @XmlElement(name = "AmtsdVal", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
