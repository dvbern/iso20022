...
@XmlType(name = "OrganisationIdentificationSchemeName1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "cd",
    "prtry"
})
public class OrganisationIdentificationSchemeName1Choice {

    @XmlElement(name = "Cd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String cd;
