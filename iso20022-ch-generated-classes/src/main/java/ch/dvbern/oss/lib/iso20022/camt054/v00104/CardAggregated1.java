...
@XmlType(name = "CardAggregated1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "addtlSvc",
    "txCtgy",
    "saleRcncltnId",
    "seqNbRg",
...
public class CardAggregated1 {
    ...
    @XmlElement(name = "SeqNbRg", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected CardSequenceNumberRange1 seqNbRg;
    @XmlElement(name = "TxDtRg", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
