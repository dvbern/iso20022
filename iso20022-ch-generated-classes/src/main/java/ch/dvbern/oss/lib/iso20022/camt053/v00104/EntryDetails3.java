...
@XmlType(name = "EntryDetails3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails3 {

    @XmlElement(name = "Btch", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
