...
@XmlType(name = "GenericIdentification32", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "id",
    "tp",
    "issr",
    "shrtNm"
...
public class GenericIdentification32 {
    ...
    @XmlElement(name = "Issr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    @XmlSchemaType(name = "string")
    protected PartyType4Code issr;
    @XmlElement(name = "ShrtNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
