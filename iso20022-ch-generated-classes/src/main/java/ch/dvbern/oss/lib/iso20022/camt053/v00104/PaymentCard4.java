...
@XmlType(name = "PaymentCard4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "plainCardData",
    "cardCtryCd",
    "cardBrnd",
    "addtlCardData"
...
public class PaymentCard4 {
    ...
    @XmlElement(name = "PlainCardData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected PlainCardData1 plainCardData;
    @XmlElement(name = "CardCtryCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected String cardCtryCd;
    @XmlElement(name = "CardBrnd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected GenericIdentification1 cardBrnd;
    @XmlElement(name = "AddtlCardData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
