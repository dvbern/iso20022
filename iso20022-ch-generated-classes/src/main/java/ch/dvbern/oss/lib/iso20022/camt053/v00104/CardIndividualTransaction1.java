...
@XmlType(name = "CardIndividualTransaction1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "addtlSvc",
    "txCtgy",
    "saleRcncltnId",
    "saleRefNb",
...
public class CardIndividualTransaction1 {
    ...
    @XmlElement(name = "SaleRefNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    ...
    @XmlElement(name = "Pdct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected Product2 pdct;
    @XmlElement(name = "VldtnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar vldtnDt;
    @XmlElement(name = "VldtnSeqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
