...
@XmlType(name = "PostalAddress6", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "adrTp",
    "dept",
    "subDept",
    "strtNm",
...
public class PostalAddress6 {
    ...
    @XmlElement(name = "AdrTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    @XmlSchemaType(name = "string")
    protected AddressType2Code adrTp;
    @XmlElement(name = "Dept", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String dept;
    @XmlElement(name = "SubDept", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String subDept;
    @XmlElement(name = "StrtNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String strtNm;
    @XmlElement(name = "BldgNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String bldgNb;
    @XmlElement(name = "PstCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String pstCd;
    @XmlElement(name = "TwnNm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String twnNm;
    @XmlElement(name = "CtrySubDvsn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String ctrySubDvsn;
    @XmlElement(name = "Ctry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
    protected String ctry;
    @XmlElement(name = "AdrLine", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
