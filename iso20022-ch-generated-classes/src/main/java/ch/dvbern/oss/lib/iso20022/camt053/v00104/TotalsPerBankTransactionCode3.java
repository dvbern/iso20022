...
@XmlType(name = "TotalsPerBankTransactionCode3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "nbOfNtries",
    "sum",
    "ttlNetNtry",
    "fcstInd",
...
public class TotalsPerBankTransactionCode3 {
    ...
    @XmlElement(name = "TtlNetNtry", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
    protected AmountAndDirection35 ttlNetNtry;
    @XmlElement(name = "FcstInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
