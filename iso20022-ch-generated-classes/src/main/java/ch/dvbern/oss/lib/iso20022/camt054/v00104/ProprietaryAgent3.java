...
@XmlType(name = "ProprietaryAgent3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "tp",
    "agt"
})
public class ProprietaryAgent3 {
    ...
    protected String tp;
    @XmlElement(name = "Agt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
