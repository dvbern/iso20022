...
@XmlType(name = "AmountRangeBoundary1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", propOrder = {
    "bdryAmt",
    "incl"
})
public class AmountRangeBoundary1 {

    @XmlElement(name = "BdryAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04", required = true)
    protected BigDecimal bdryAmt;
    @XmlElement(name = "Incl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.04")
