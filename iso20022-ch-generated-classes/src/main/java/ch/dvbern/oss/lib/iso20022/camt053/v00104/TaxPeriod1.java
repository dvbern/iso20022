...
@XmlType(name = "TaxPeriod1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04", propOrder = {
    "yr",
    "tp",
    "frToDt"
})
public class TaxPeriod1 {
    ...
    @XmlElement(name = "Yr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.04")
